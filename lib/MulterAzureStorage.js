...
var MulterAzureStorage = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            return [3 /*break*/ , 6];
          case 4:
            return [4 /*yield*/ , this._deleteBlobIfExists(containerName, file.blobName)];
          case 5:
            _a.sent();
            cb(null);
            _a.label = 6;
  ...
  MulterAzureStorage.prototype._createContainerIfNotExists = function (name, accessLevel) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (accessLevel) {
        _this._blobService.createContainerIfNotExists(name, {
  ...
  MulterAzureStorage.prototype._getUrl = function (containerName, blobName, expiration) {
    if (expiration === void 0) {
      expiration = this._urlExpirationTime;
    }
